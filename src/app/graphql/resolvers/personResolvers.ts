...
export const personResolvers = {
  ...
  Person: {
    __resolveType(person: PersonRecord): string {
      const ageLimit = moment().subtract(16, 'years')

      return moment(person.birthDay) < ageLimit ? 'Employee' : 'Underage'
    }
  },
